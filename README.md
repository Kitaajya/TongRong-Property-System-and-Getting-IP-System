...
> **注⚠️：本人声明，此说明书本人懒得写，直接用deepseek生成的，还有前端界面代码是Opencode AI写的，因为我早就不学前端三件套了，所以关于前端的框架知识已经忘得一干二净。前端界面我用的感觉良好，如果有建议修改的话可以联系我。如果本系统有什么问题与本说明书不符，可以发QQ邮箱联系本人，联系方式在最下面**
